...
export default function CompleteDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0C10] text-white flex flex-col md:flex-row pb-24 md:pb-0">
      ...
      {/* 1. FIXED SIDEBAR FOR DESKTOP & BOTTOM NAV FOR MOBILE */}
      ...
      {/* 2. MAIN CONTENT AREA (CLEAN WITH CONTAINER WRAPPER) */}
        ...
        {activeTab === "dashboard" && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-[#1F2833]/50 p-6 rounded-2xl border border-gray-800 backdrop-blur-sm shadow-sm hover:border-[#FF9F1C]/30 transition-all">
              ...
              <div className="bg-[#1F2833]/50 p-6 rounded-2xl border border-gray-800 backdrop-blur-sm shadow-sm hover:border-white/10 transition-all">
                ...
                <span className="text-xs text-[#FF9F1C] block mt-2">★ VIP Tier 2 Active</span>
              </div>
              <div className="bg-[#1F2833]/50 p-6 rounded-2xl border border-gray-800 backdrop-blur-sm shadow-sm hover:border-green-500/20 transition-all sm:col-span-2 lg:col-span-1">
                ...
                <span className="text-xs text-gray-400 block mt-2">Next distribution in 2 days</span>
              </div>
            </div>

            {/* Live Market Chart Representation */}
                ...
                <table className="w-full text-left border-collapse min-w-[500px]">
                  ...
                  <tbody className="text-sm divide-y divide-gray-800/40">
                    ...
                    <tr className="hover:bg-gray-900/30 transition-colors">
                      ...
                      <td className="py-4 px-4 text-green-400 font-semibold">+$50.00</td>
                      <td className="py-4 px-4">
                        <span className="bg-green-500/10 text-green-400 text-xs px-2.5 py-1 rounded-full border border-green-500/20">Completed</span>
                      </td>
                    </tr>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
              <div className="bg-[#1F2833]/40 p-6 rounded-2xl border border-gray-800 flex flex-col justify-between hover:border-gray-700 transition-all">
                ...
                <button className="w-full bg-gray-800 text-white font-medium py-3 rounded-xl transition-all mt-8 border border-gray-700">Activate Plan</button>
              </div>
              ...
              <div className="bg-[#1F2833]/70 p-6 rounded-2xl border-2 border-[#FF9F1C] flex flex-col justify-between relative shadow-xl shadow-[#FF9F1C]/5">
                ...
                <button className="w-full bg-[#FF9F1C] hover:bg-[#e08b14] text-black font-bold py-3 rounded-xl transition-all mt-8 shadow-lg shadow-[#FF9F1C]/10">Activate Plan</button>
              </div>
