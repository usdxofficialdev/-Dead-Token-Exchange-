  ...
  return (
    <div className="min-h-screen bg-black text-white p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {/* Top Welcome Banner with Gold Accent */}
        <div className="bg-zinc-900/60 border border-zinc-800 rounded-2xl p-6 shadow-glow-gold">
          <h1 className="text-3xl font-black text-gold-500 tracking-wider mb-2">
            ⚡ USDX DASHBOARD
          </h1>
          <h3 className="text-xl font-medium text-zinc-300">
            Welcome back, <span className="text-gold-400 font-bold">{userName}</span>
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-xl transition-all duration-300 hover:border-gold-500/50 hover:shadow-glow-gold">
            <p className="text-zinc-500 text-sm font-semibold uppercase tracking-wider">Balance</p>
            <h2 className="text-3xl font-black text-gold-400 mt-1">${data.balance}</h2>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-xl transition-all duration-300 hover:border-gold-500/50 hover:shadow-glow-gold">
            <p className="text-zinc-500 text-sm font-semibold uppercase tracking-wider">Staking</p>
            <h2 className="text-3xl font-black text-gold-400 mt-1">${data.staking}</h2>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-xl transition-all duration-300 hover:border-gold-500/50 hover:shadow-glow-gold">
            <p className="text-zinc-500 text-sm font-semibold uppercase tracking-wider">Rewards</p>
            <h2 className="text-3xl font-black text-gold-400 mt-1">${data.rewards}</h2>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-xl transition-all duration-300 hover:border-gold-500/50 hover:shadow-glow-gold">
            <p className="text-zinc-500 text-sm font-semibold uppercase tracking-wider">Referral</p>
            <h2 className="text-3xl font-black text-gold-400 mt-1">${data.referral}</h2>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-xl transition-all duration-300 hover:border-gold-500/50 hover:shadow-glow-gold">
